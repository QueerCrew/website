<template>
    <QcHero id="hero" title="DnB beim CSD" />

    <section id="content" class="relative z-10 py-16">
        <HeLimiter size="text">
            <img src="/images/events/2025_08_09_csd_truck.png" alt="QC CSD VSE Truck 2025" class="w-full h-auto rounded-lg" />
            <p class="mt-8">
                <b>Bock auf fette Beats beim CSD?</b><br>
